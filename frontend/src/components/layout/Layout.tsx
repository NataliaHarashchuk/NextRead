      ...
      <List>
        ...
        <ListItem disablePadding>
          <ListItemButton component={Link} to="/books">
            ...
            <ListItemText primary="Каталог книг" />
          </ListItemButton>
        </ListItem>
        {isAuthenticated && (
          <ListItem disablePadding>
            <ListItemButton component={Link} to="/my-borrowings">
              <ListItemIcon>
                <LibraryBooksIcon />
              </ListItemIcon>
              <ListItemText primary="Мої книги" />
            </ListItemButton>
          </ListItem>
        )}
        {!isAuthenticated && (
      ...
      >
        <Container maxWidth="xl">
          <Typography variant="body2" color="text.secondary" align="center">
            © 2026 Next Read - Система управління бібліотекою
          </Typography>
        </Container>
      </Box>
    </Box>
